...
export class AuthorizationService {
  ...
  public createToken1(
    ...
    if (signatureId === null || signatureId === undefined) {
      throw new Error(
        'Required parameter signatureId was null or undefined when calling createToken1.'
      );
    }
    ...
    return this.httpClient.get<any>(
      `${this.configuration.basePath}/auth/${encodeURIComponent(
        String(signatureId)
      )}/token`,
      {
  ...
  public createTokens1(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<Array<Token>>>;
  public createTokens1(
    reauthorize?: boolean,
    body?: Credentials,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<Array<Token>>>;
  public createTokens1(
    reauthorize?: boolean,
    body?: Credentials,
    observe: any = 'body',
    ...
    if (reauthorize !== undefined && reauthorize !== null) {
    ...
    return this.httpClient.post<Array<Token>>(
      `${this.configuration.basePath}/auth/external/tokens`,
      body,
      {
        context: localVarHttpContext,

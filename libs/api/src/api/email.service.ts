...
import { EmailInitParams } from '../model/models';
import { ParisEmail } from '../model/models';
...
export class EmailService {
   ...
   */
  public initEmail1(
    body?: EmailInitParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<ParisEmail>;
  public initEmail1(
    body?: EmailInitParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<ParisEmail>>;
  public initEmail1(
    body?: EmailInitParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<ParisEmail>>;
  public initEmail1(
    body?: EmailInitParams,
    observe: any = 'body',
    ...
    return this.httpClient.post<ParisEmail>(
      `${this.configuration.basePath}/email/init`,
      body,
      {
  ...
  /**
   * @param email json structure of ParisEmail
   * @param attachments
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */

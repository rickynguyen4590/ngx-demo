...
import { OfferMarineObject } from '../model/models';
import { OfferMarineObjectConnectParams } from '../model/models';
...
export class OfferMarineObjectsService {
  ...
  public connectObjects(
    body?: OfferMarineObjectConnectParams,
    observe?: 'body',
  ...
  public connectObjects(
    ...
    return this.httpClient.post<any>(
      `${this.configuration.basePath}/offermarine/objects/connectobjects`,
      body,
      {
  ...
  public disconnectObjects(
    ...
    return this.httpClient.post<any>(
      `${this.configuration.basePath}/offermarine/objects/disconnectobjects`,
      body,
      {
        context: localVarHttpContext,
        responseType: <any>responseType_,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getOfferMarineObject1(
    id: string,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<OfferMarineObject>;
  public getOfferMarineObject1(
    id: string,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<OfferMarineObject>>;
  public getOfferMarineObject1(
    id: string,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<OfferMarineObject>>;
  public getOfferMarineObject1(
    id: string,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getOfferMarineObject1.'
      );
    }
    ...
    return this.httpClient.get<OfferMarineObject>(
      `${this.configuration.basePath}/offermarine/objects/${encodeURIComponent(
        String(id)
      )}`,
      {
        context: localVarHttpContext,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getOfferMarineObjects1(
    agreementId?: string,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<Array<OfferMarineObject>>;
  public getOfferMarineObjects1(
    agreementId?: string,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<Array<OfferMarineObject>>>;
  public getOfferMarineObjects1(
    agreementId?: string,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<Array<OfferMarineObject>>>;
  public getOfferMarineObjects1(
    agreementId?: string,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    return this.httpClient.get<Array<OfferMarineObject>>(
      `${this.configuration.basePath}/offermarine/objects`,
      {
        context: localVarHttpContext,

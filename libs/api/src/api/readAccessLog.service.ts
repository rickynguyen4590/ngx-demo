...
import { SearchResultReadAccessLog } from '../model/models';
...
export class ReadAccessLogService {
   ...
   * @param entityType
   * @param entityKey
   * @param accessDateFrom
   * @param accessDateTo
   * @param accessedBy
   * @param accessedByUser
   * @param orderBy
   * @param orderByDirection
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getReadAccessLog1(
    eventType: 'ENTITY_ACCESS' | 'USER_LOGIN',
    firstResult?: number,
    maxResults?: number,
    entityType?:
      | 'CLAIM'
    ...
    accessDateTo?: string,
    accessedBy?: string,
    accessedByUser?: number,
    orderBy?: 'ID' | 'ACCESS_DATE',
    orderByDirection?: 'ASC' | 'DESC',
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<SearchResultReadAccessLog>;
  public getReadAccessLog1(
    eventType: 'ENTITY_ACCESS' | 'USER_LOGIN',
    firstResult?: number,
    maxResults?: number,
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<SearchResultReadAccessLog>>;
  public getReadAccessLog1(
    eventType: 'ENTITY_ACCESS' | 'USER_LOGIN',
    firstResult?: number,
    maxResults?: number,
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<SearchResultReadAccessLog>>;
  public getReadAccessLog1(
    eventType: 'ENTITY_ACCESS' | 'USER_LOGIN',
    firstResult?: number,
    maxResults?: number,
    ...
    if (eventType === null || eventType === undefined) {
      throw new Error(
        'Required parameter eventType was null or undefined when calling getReadAccessLog1.'
      );
    }
    ...
    if (accessDateFrom !== undefined && accessDateFrom !== null) {
      localVarQueryParameters = this.addToHttpParams(
        localVarQueryParameters,
        <any>accessDateFrom,
        'accessDateFrom'
    ...
    if (accessDateTo !== undefined && accessDateTo !== null) {
      localVarQueryParameters = this.addToHttpParams(
        localVarQueryParameters,
        <any>accessDateTo,
        'accessDateTo'
    ...
    if (accessedBy !== undefined && accessedBy !== null) {
      localVarQueryParameters = this.addToHttpParams(
        localVarQueryParameters,
        <any>accessedBy,
        'accessedBy'
    ...
    if (accessedByUser !== undefined && accessedByUser !== null) {
      localVarQueryParameters = this.addToHttpParams(
        localVarQueryParameters,
        <any>accessedByUser,
        'accessedByUser'
    ...
    return this.httpClient.get<SearchResultReadAccessLog>(
      `${this.configuration.basePath}/readaccesslog`,
      {

...
import { Responsible } from '../model/models';
...
export class ResponsiblesService {
  ...
  public create12(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<Responsible>>;
  public create12(
    body?: Responsible,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<Responsible>>;
  public create12(
    body?: Responsible,
    observe: any = 'body',
    ...
    return this.httpClient.post<Responsible>(
      `${this.configuration.basePath}/responsibles`,
      body,
      {
  ...
  public delete3(
    ...
    return this.httpClient.delete<any>(
      `${this.configuration.basePath}/responsibles/${encodeURIComponent(
        String(id)
      )}`,
      {
        context: localVarHttpContext,
  ...
  public getResponsibles(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<Array<Responsible>>>;
  public getResponsibles(
    type: 'CLAIM',
    key: string,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<Array<Responsible>>>;
  public getResponsibles(
    type: 'CLAIM',
    key: string,
    observe: any = 'body',
    ...
    if (type === null || type === undefined) {
      throw new Error(
        'Required parameter type was null or undefined when calling getResponsibles.'
      );
    }
    if (key === null || key === undefined) {
      throw new Error(
        'Required parameter key was null or undefined when calling getResponsibles.'
      );
    }
    ...
    return this.httpClient.get<Array<Responsible>>(
      `${this.configuration.basePath}/responsibles`,
      {
        context: localVarHttpContext,

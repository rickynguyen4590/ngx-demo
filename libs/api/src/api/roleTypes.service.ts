...
import { RoleType } from '../model/models';
...
export class RoleTypesService {
  ...
  /**
   * @param roleDomainType
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getRoleTypes1(
    roleDomainType?:
      | 'AGREEMENT'
      | 'CLAIM'
      | 'CLAIM_INTERNAL'
  ...
  public getRoleTypes1(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<Array<RoleType>>>;
  public getRoleTypes1(
    roleDomainType?:
      | 'AGREEMENT'
      | 'CLAIM'
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<Array<RoleType>>>;
  public getRoleTypes1(
    roleDomainType?:
      | 'AGREEMENT'
      | 'CLAIM'
    ...
    if (roleDomainType !== undefined && roleDomainType !== null) {
    ...
    return this.httpClient.get<Array<RoleType>>(
      `${this.configuration.basePath}/roletypes`,
      {

...
import { GeneralLedgerAccount } from '../model/models';
...
export class SystemCodesAccountingCodesService {
  ...
  public getBankAccounts2(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<Array<BankAccount>>>;
  public getBankAccounts2(
    currency?: string,
    busnBranch?: number,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<Array<BankAccount>>>;
  public getBankAccounts2(
    currency?: string,
    busnBranch?: number,
    observe: any = 'body',
    ...
    if (busnBranch !== undefined && busnBranch !== null) {
      localVarQueryParameters = this.addToHttpParams(
        localVarQueryParameters,
        <any>busnBranch,
        'busnBranch'
    ...
    return this.httpClient.get<Array<BankAccount>>(
      `${this.configuration.basePath}/systemcodes/accountingcodes/bankaccounts`,
      {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getGeneralLedgerAccounts1(
    claimUsage?: boolean,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<Array<GeneralLedgerAccount>>;
  public getGeneralLedgerAccounts1(
    claimUsage?: boolean,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<Array<GeneralLedgerAccount>>>;
  public getGeneralLedgerAccounts1(
    claimUsage?: boolean,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<Array<GeneralLedgerAccount>>>;
  public getGeneralLedgerAccounts1(
    claimUsage?: boolean,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    let localVarQueryParameters = new HttpParams({ encoder: this.encoder });
    if (claimUsage !== undefined && claimUsage !== null) {
      localVarQueryParameters = this.addToHttpParams(
        localVarQueryParameters,
        <any>claimUsage,
        'claimUsage'
    ...
    return this.httpClient.get<Array<GeneralLedgerAccount>>(
      `${this.configuration.basePath}/systemcodes/accountingcodes/generalledgeraccounts`,
      {
        context: localVarHttpContext,
        params: localVarQueryParameters,
        responseType: <any>responseType_,

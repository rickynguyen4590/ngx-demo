...
import { ActivityGroup } from '../model/models';
...
export class SystemCodesActivityCodesService {
   ...
   */
  public getActivityCategories1(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<Array<ActivityCategory>>;
  public getActivityCategories1(
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<Array<ActivityCategory>>>;
  public getActivityCategories1(
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<Array<ActivityCategory>>>;
  public getActivityCategories1(
    observe: any = 'body',
    ...
    return this.httpClient.get<Array<ActivityCategory>>(
      `${this.configuration.basePath}/systemcodes/activitycategories`,
      {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getActivityGroups1(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<Array<ActivityGroup>>;
  public getActivityGroups1(
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<Array<ActivityGroup>>>;
  public getActivityGroups1(
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<Array<ActivityGroup>>>;
  public getActivityGroups1(
    observe: any = 'body',
    reportProgress: boolean = false,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
    ...
    return this.httpClient.get<Array<ActivityGroup>>(
      `${this.configuration.basePath}/systemcodes/activitygroups`,
      {
        context: localVarHttpContext,
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,

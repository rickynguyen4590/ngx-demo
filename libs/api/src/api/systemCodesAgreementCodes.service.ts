...
import { LostCode } from '../model/models';
import { OrderCode } from '../model/models';
...
export class SystemCodesAgreementCodesService {
  ...
  public getAgreementTypes1(
    ...
    return this.httpClient.get<Array<string>>(
      `${this.configuration.basePath}/systemcodes/agreementcodes/agreementtypes`,
      {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getLostCodes1(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<Array<LostCode>>;
  public getLostCodes1(
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<Array<LostCode>>>;
  public getLostCodes1(
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<Array<LostCode>>>;
  public getLostCodes1(
    observe: any = 'body',
    reportProgress: boolean = false,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
    ...
    return this.httpClient.get<Array<LostCode>>(
      `${this.configuration.basePath}/systemcodes/agreementcodes/lostcodes`,
      {
        context: localVarHttpContext,
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getOrderCodes1(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<Array<OrderCode>>;
  public getOrderCodes1(
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<Array<OrderCode>>>;
  public getOrderCodes1(
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<Array<OrderCode>>>;
  public getOrderCodes1(
    observe: any = 'body',
    reportProgress: boolean = false,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
    ...
    return this.httpClient.get<Array<OrderCode>>(
      `${this.configuration.basePath}/systemcodes/agreementcodes/ordercodes`,
      {
        context: localVarHttpContext,
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,

...
import { FortSectorCode } from '../model/models';
import { FortTradeCode } from '../model/models';
...
export class SystemCodesAuthorityReportsCodesService {
   ...
   */
  public getFortSectorCodes1(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<Array<FortSectorCode>>;
  public getFortSectorCodes1(
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<Array<FortSectorCode>>>;
  public getFortSectorCodes1(
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<Array<FortSectorCode>>>;
  public getFortSectorCodes1(
    observe: any = 'body',
    ...
    return this.httpClient.get<Array<FortSectorCode>>(
      `${this.configuration.basePath}/systemcodes/authorityreportscodes/fortsector`,
      {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getFortTradeCodes1(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<Array<FortTradeCode>>;
  public getFortTradeCodes1(
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<Array<FortTradeCode>>>;
  public getFortTradeCodes1(
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<Array<FortTradeCode>>>;
  public getFortTradeCodes1(
    observe: any = 'body',
    reportProgress: boolean = false,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
    ...
    return this.httpClient.get<Array<FortTradeCode>>(
      `${this.configuration.basePath}/systemcodes/authorityreportscodes/forttrade`,
      {
        context: localVarHttpContext,
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,

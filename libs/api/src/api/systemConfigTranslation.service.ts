...
export class SystemConfigTranslationService {
   ...
   */
  public getTranslations1(
    translationType: 'USER_NOTIFICATION_TYPE' | 'PRODUCT',
    codeValue: string,
    observe?: 'body',
  ...
  public getTranslations1(
    ...
    if (translationType === null || translationType === undefined) {
      throw new Error(
        'Required parameter translationType was null or undefined when calling getTranslations1.'
      );
    }
    if (codeValue === null || codeValue === undefined) {
      throw new Error(
        'Required parameter codeValue was null or undefined when calling getTranslations1.'
      );
    }
    ...
    return this.httpClient.get<Array<Translation>>(
      `${
        this.configuration.basePath
      }/systemconfig/translation/${encodeURIComponent(
        String(translationType)
      )}/${encodeURIComponent(String(codeValue))}`,
      {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public updateTranslations1(
    translationType: 'USER_NOTIFICATION_TYPE' | 'PRODUCT',
    codeValue: string,
    body?: Array<Translation>,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public updateTranslations1(
    ...
    if (translationType === null || translationType === undefined) {
      throw new Error(
        'Required parameter translationType was null or undefined when calling updateTranslations1.'
      );
    }
    if (codeValue === null || codeValue === undefined) {
      throw new Error(
        'Required parameter codeValue was null or undefined when calling updateTranslations1.'
      );
    }

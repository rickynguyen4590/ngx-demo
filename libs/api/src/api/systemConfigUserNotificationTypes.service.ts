...
import { UserNotificationType } from '../model/models';
...
export class SystemConfigUserNotificationTypesService {
   ...
   */
  public getUserNotificationTypes1(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<Array<UserNotificationType>>;
  public getUserNotificationTypes1(
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<Array<UserNotificationType>>>;
  public getUserNotificationTypes1(
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<Array<UserNotificationType>>>;
  public getUserNotificationTypes1(
    observe: any = 'body',
    ...
    return this.httpClient.get<Array<UserNotificationType>>(
      `${this.configuration.basePath}/systemconfig/usernotifications`,
      {
   ...
   */
  public update14(
    body?: UserNotificationType,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<UserNotificationType>;
  public update14(
    body?: UserNotificationType,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<UserNotificationType>>;
  public update14(
    body?: UserNotificationType,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<UserNotificationType>>;
  public update14(
    body?: UserNotificationType,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    return this.httpClient.put<UserNotificationType>(
      `${this.configuration.basePath}/systemconfig/usernotifications`,
      body,
      {
        context: localVarHttpContext,

...
import { TimelineEvent } from '../model/models';
...
export class TimelineService {
  ...
  public getTimeline1(
    ...
    person?: number,
    fullText?: string,
    groups?: Array<'ACTIVITIES' | 'MESSAGES' | 'NOTES'>,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<Array<TimelineEvent>>;
  public getTimeline1(
    maxResults?: number,
    messageType?:
      | 'AGREEMENT_A'
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<Array<TimelineEvent>>>;
  public getTimeline1(
    maxResults?: number,
    messageType?:
      | 'AGREEMENT_A'
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<Array<TimelineEvent>>>;
  public getTimeline1(
    maxResults?: number,
    messageType?:
      | 'AGREEMENT_A'
    ...
    return this.httpClient.get<Array<TimelineEvent>>(
      `${this.configuration.basePath}/timeline`,
      {

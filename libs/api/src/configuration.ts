...
export class Configuration {
  ...
  constructor(configurationParameters: ConfigurationParameters = {}) {
    ...
    // init default paris-api-key credential
    if (!this.credentials['paris-api-key']) {
      this.credentials['paris-api-key'] = () => {
        if (this.apiKeys === null || this.apiKeys === undefined) {
          return undefined;
        } else {
          return this.apiKeys['paris-api-key'] || this.apiKeys['paris-api-key'];
        }
      };
    }
  }

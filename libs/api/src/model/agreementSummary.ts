...
export interface AgreementSummary {
  ...
  businessResultOpenNet?: number;
  closedNet?: number;
  paidPremium?: number;
  outstandingClaims?: number;
  settledClaims?: number;
  commissionFromInsurer?: number;
  commissionToAgents?: number;
  commissionToPartiesInFront?: number;
  commissionToAgentsAndPartiesInFront?: number;

...
export interface ApplicableCoverageCoshare {
  broker?: SimplePerson;
  insurer?: SimplePerson;
  advice?: ApplicableCoverageCoshare.AdviceEnum;
  share?: number;
  ratingCompany?: SimplePerson;
  ratingCode?: string;
  ratingCodeName?: string;
  ratingDate?: string;
  ratingLastUpdatedBy?: string;
  ratingLastUpdated?: string;
}
export namespace ApplicableCoverageCoshare {
  export type AdviceEnum = 'ON_BROKER_B' | 'NONE_N' | 'ON_PARTISIP_P';
  export const AdviceEnum = {
    OnBrokerB: 'ON_BROKER_B' as AdviceEnum,
    NoneN: 'NONE_N' as AdviceEnum,
    OnPartisipP: 'ON_PARTISIP_P' as AdviceEnum,
  };
}

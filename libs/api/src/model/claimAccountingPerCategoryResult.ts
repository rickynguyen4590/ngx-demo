 ...
 */
import { ClaimAccountingPerCategory } from './claimAccountingPerCategory';

export interface ClaimAccountingPerCategoryResult {
  claimAccountingPerCategory?: Array<ClaimAccountingPerCategory>;
  currency?: string;
  sumReserve?: number;
  sumSettled?: number;
  sumTotal?: number;

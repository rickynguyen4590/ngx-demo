...
export interface ClaimAccountingPerDocNoSums {
  currency?: string;
  sumBalance?: number;
  sumReserve?: number;
  sumReserve100pct?: number;
  sumSettled?: number;
  sumSettled100pct?: number;
  sumPersonalLedgerBalance?: number;
  sumGeneralLedgerBalance?: number;
  sumInternalAmount?: number;
}

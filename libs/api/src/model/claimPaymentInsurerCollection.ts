 ...
 */
import { ClaimPaymentInsurerCollectionLine } from './claimPaymentInsurerCollectionLine';
import { SimplePerson } from './simplePerson';

export interface ClaimPaymentInsurerCollection {
  insurer: SimplePerson;
  insurerCollectionLines?: Array<ClaimPaymentInsurerCollectionLine>;
}

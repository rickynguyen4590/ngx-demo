 ...
 */
import { ClaimPaymentInsurerCollection } from './claimPaymentInsurerCollection';
import { InsurerCollectionBeneficiaryStatus } from './insurerCollectionBeneficiaryStatus';

export interface ClaimPaymentInsurerCollectionStatus {
  unprocessedPayments?: boolean;
  referenceBase?: number;
  beneficiaryStatus?: Array<InsurerCollectionBeneficiaryStatus>;
  insurerCollection?: Array<ClaimPaymentInsurerCollection>;
}

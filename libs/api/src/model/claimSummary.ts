 ...
 */
import { ClaimCasualtySalary } from './claimCasualtySalary';
import { ClaimInternalExpenses } from './claimInternalExpenses';

export interface ClaimSummary {
  sumCoveredAmount?: number;
  sumDeductibleAmount?: number;
  sumInterest?: number;
  totalCoveredAmount?: number;
  totalSumCoveredAmount?: number;
  totalSumCoveredAmountOurShare?: number;
  totalSumCoveredAmountNotOurShare?: number;
  restCoveredAmount?: number;
  restCoveredAmountNotOurShare?: number;
  unpaidPremium?: number;
  paidOwner?: number;
  paidOthers?: number;
  totalPaid?: number;
  sumActualPaidIngoingInvoices?: number;
  sumActualPaidWithoutIngoingInvoices?: number;
  sumIngoingInvoicesNotToPay?: number;
  claimCasualtySalary?: ClaimCasualtySalary;
  claimInternalExpenses?: ClaimInternalExpenses;
}

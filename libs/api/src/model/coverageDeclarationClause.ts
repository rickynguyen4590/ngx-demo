...
export interface CoverageDeclarationClause {
  created?: string;
  createdBy?: string;
  lastUpdated?: string;
  lastUpdatedBy?: string;
  id?: string;
  coverageDeclarationId?: string;
  lineNumber?: number;
  type?: CoverageDeclarationClause.TypeEnum;
  documentId?: number;
  note?: string;
  textPlaceCode?: string;
  fixedTextTemplateId?: number;
  specialTextId?: string;
}
export namespace CoverageDeclarationClause {
  export type TypeEnum = 'ATTACHMENT_A' | 'FIXED_TEXT_F' | 'VARIABLE_TEXT_V';
  export const TypeEnum = {
    AttachmentA: 'ATTACHMENT_A' as TypeEnum,
    FixedTextF: 'FIXED_TEXT_F' as TypeEnum,
    VariableTextV: 'VARIABLE_TEXT_V' as TypeEnum,
  };
}

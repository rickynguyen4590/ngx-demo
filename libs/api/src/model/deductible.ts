...
export interface Deductible {
  ...
  days?: number;
  limitDays?: number;
  amountCode?: Deductible.AmountCodeEnum;
  description?: string;
}
export namespace Deductible {
  export type AmountCodeEnum = 'INTEREST_I' | '_100__T';
  export const AmountCodeEnum = {
    InterestI: 'INTEREST_I' as AmountCodeEnum,
    _100T: '_100__T' as AmountCodeEnum,
  };
}

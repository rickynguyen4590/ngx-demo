...
export interface ExportToParisParams {
  postOperation?: ExportToParisParams.PostOperationEnum;
  lostCode?: string;
  lostText?: string;
}
export namespace ExportToParisParams {
  export type PostOperationEnum =
    | 'None'
    | 'InvoiceDraft'
    | 'EstablishAndDocuments';
  export const PostOperationEnum = {
    None: 'None' as PostOperationEnum,
    InvoiceDraft: 'InvoiceDraft' as PostOperationEnum,
    EstablishAndDocuments: 'EstablishAndDocuments' as PostOperationEnum,
  };
}

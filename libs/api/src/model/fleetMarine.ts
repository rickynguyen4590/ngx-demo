...
export interface FleetMarine {
  ...
  contactPerson?: SimplePerson;
  status: FleetMarine.StatusEnum;
  note?: string;
  statusLastUpdated?: string;
  statusLastUpdatedBy?: string;
}
export namespace FleetMarine {
  ...
  export const StatusEnum = {
    ...
    DeclinedD: 'DECLINED_D' as StatusEnum,
    ExpiredE: 'EXPIRED_E' as StatusEnum,
    ProspectP: 'PROSPECT_P' as StatusEnum,
  };
}

...
export interface FormSubmission {
  ...
  codeValue?: string;
  internalNote?: string;
  status?: FormSubmission.StatusEnum;
  created?: string;
  createdBy?: string;
...
export namespace FormSubmission {
  export type StatusEnum = 'DRAFT_D' | 'PROCESSED_P' | 'SUBMITTED_S';
  export const StatusEnum = {
    DraftD: 'DRAFT_D' as StatusEnum,
    ProcessedP: 'PROCESSED_P' as StatusEnum,
    SubmittedS: 'SUBMITTED_S' as StatusEnum,
  };
}

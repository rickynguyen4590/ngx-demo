 ...
 */
import { OfferMarineDeductibleSetValues } from './offerMarineDeductibleSetValues';
import { OfferMarineDeductibleSetLines } from './offerMarineDeductibleSetLines';

export interface OfferMarineDeductibleSet {
  ...
  addMachDeductionAmount?: number;
  collisionDeductionAmount?: number;
  iceDeductionAmount?: number;
  dailyDeductionAmount?: number;
  deductionDays?: number;
  addMachDeductionDays?: number;
  daysPerClaim?: number;
  daysInAll?: number;
  deductibleCode1?: string;
  deductibleCode2?: string;
  deductibleCode1Amount?: number;
  deductibleCode2Amount?: number;
  stopUse?: boolean;
  values?: Array<OfferMarineDeductibleSetValues>;
  lines?: Array<OfferMarineDeductibleSetLines>;
}

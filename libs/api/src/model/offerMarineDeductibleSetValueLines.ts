...
export interface OfferMarineDeductibleSetValueLines {
  id?: string;
  deductibleSetValuesId?: string;
  deductibleCode: string;
  lineNumber?: number;
  deductibleBreak?: string;
  ...
  note?: string;
  percentage?: number;
  percentageType?: OfferMarineDeductibleSetValueLines.PercentageTypeEnum;
}
export namespace OfferMarineDeductibleSetValueLines {
  export type PercentageTypeEnum =
    | 'PERCENTAGE__'
    | 'FRACTION_F'
    | 'PRO_MILLE_M'
    | 'UNKNOWN_Z';
  export const PercentageTypeEnum = {
    Percentage: 'PERCENTAGE__' as PercentageTypeEnum,
    FractionF: 'FRACTION_F' as PercentageTypeEnum,
    ProMilleM: 'PRO_MILLE_M' as PercentageTypeEnum,
    UnknownZ: 'UNKNOWN_Z' as PercentageTypeEnum,
  };
}

...
export interface PaymentCode {
  ...
  description?: string;
  stopUse?: boolean;
  considerReversedChargeVATWarning?: boolean;
  defaultGeneralLedgerAccount?: boolean;
  defaultGeneralLedgerAccountDIR?: number;
  defaultGeneralLedgerAccountCO?: number;
  defaultGeneralLedgerAccountRE?: number;
}
